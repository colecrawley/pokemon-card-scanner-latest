  ...
  Widget _buildTopPerformersCard(List<CardData> cards, String title, {bool isGainer = true}) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: isDarkMode ? Colors.black87.withOpacity(0.5) : Colors.black.withOpacity(0.1),
            spreadRadius: 2,
            blurRadius: 10,
  ...
  Widget _buildTopPerformersList(List<CardData> cards, bool isGainer) {
      ...
      return Padding(
        ...
        child: Center(
          child: Text(
            ...
            style: TextStyle(color: Theme.of(context).brightness == Brightness.dark ? Colors.grey[400] : Colors.grey),
          ),
        ),
      );
    }
    ...
    return Column(
      children: cards.map((card) => Card(
        ...
        color: Theme.of(context).brightness == Brightness.dark ? Colors.grey[700] : null,
        child: ListTile(
